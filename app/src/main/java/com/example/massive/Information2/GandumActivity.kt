...
import com.example.massive.databinding.ActivityGandumBinding

class GandumActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGandumBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityGandumBinding.inflate(layoutInflater)
